            ...
            <div className='signin grid place-items-center font-sans max-w-4xl mx-auto h-screen'>
                ...
                sm:w-10/12 w-7/12 md:7/12 rounded-md'>
                    ...
                    <div className='footer d-block w-full flex xs:justify-center justify-end mt-5'>
                        <button onClick={e => handleSubmit(e, 'click')} className='bg-gradient-shadow relative rounded-full xs:w-full px-7 py-2 bg-gradient-to-tr from-[#F7B12D] via-[#FA8247] to-[#FC585D] text-base font-medium text-white hover:opacity-90 focus:outline-none focus:ring-4 focus:ring-offset-0 focus:ring-[#f7b02d39]'>登録</button>
                    </div>
